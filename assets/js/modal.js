...
var ModalDialog = (function () {
  ...
  return function(cfg, window, d, debounce) {
    ...
    var svgCloseId = "icon-cross";
    var svgCloseClass = "svg-close";
    var svgLoadingId = "icon-loading";
    var svgLoadingClass = "svg-loading";
    ...
    var _openModal = function (e) {
      ...
      //console.log(e.target.tagName, _getTarget(e.target).tagName);
      //var target = e.target;
      //if (!target.modalSrc) {
    ...
    var _keydown_openerObj = function (e) {
      // enter or space pressed on the opener object
    ...
    var _getModalCloseLink = function (modalLink) {
      ...
      link.tabIndex = 0;
      link.appendChild(_getModalSVG(svgCloseId, svgCloseClass, "Close modal"));
    ...
    var _addModalSection = function(modalLink) {
      ...
      section.appendChild(_getModalSVG(svgLoadingId, svgLoadingClass, "Loading"));
    ...
    var configuration = function (cfg) {
      ...
      svgCloseId = cfg.svgCloseId || svgCloseId;
      svgCloseClass = cfg.svgCloseClass || svgCloseClass;
      svgLoadingId = cfg.svgLoadingId || svgLoadingId;
      svgLoadingClass = cfg.svgLoadingClass || svgLoadingClass;
    };


    var initialise = function (cfg, window, d, debounce) {
    ...
    return initialise(cfg, window, document, debounce);
